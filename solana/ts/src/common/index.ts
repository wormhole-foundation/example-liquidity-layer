...
export type Uint64 = bigint | anchor.BN | number;

export function isUint64(value: Uint64): boolean {
    return (
        typeof value === "bigint" ||
        (typeof value === "object" && value instanceof anchor.BN) ||
        typeof value === "number"
    );
}
...
export function uint64ToBN(value: Uint64): anchor.BN {
    const buf = Buffer.alloc(8);
    writeUint64BE(buf, value);
    return new anchor.BN(buf);
}
